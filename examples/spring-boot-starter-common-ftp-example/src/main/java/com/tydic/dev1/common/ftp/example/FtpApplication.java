...
//        log.info(""+abstractFtp.exist("/pub/ftpdirs/UNI076_LABEL_CATRGORY.20190716.821.001.DAT"));
        boolean upload = abstractFtp.upload("targrp", new File("/Users//Downloads/智慧BSS3.0系统集成方案v3.0.doc"));

        log.info(""+upload);
//        abstractFtp.download("/pub/ftpdirs/UNI076_LABEL_CATRGORY.20190721.821.001.DAT",new File("/Users//Downloads/sfz/UNI076_LABEL_CATRGORY.20190721.821.001.DAT"));
    }
}