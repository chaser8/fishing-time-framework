package com.fishingtime.framework.springcloud.gateway.handler;
...
//     * 存储处理异常后的信息
//     */
    private ThreadLocal<ResponseEntity<R>> exceptionHandlerResult = new ThreadLocal<>();
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        String message;
        ResultStatus resultStatus = ResultStatus.SYSTEM_ERROR;
        ...
        if (ex instanceof NotFoundException) {
            ...
            message = StringUtils.isEmpty(ex.getMessage()) ?resultStatus.getMessage():ex.getMessage();
            resultStatus = ResultStatus.AUTH_ERROR;
        ...
        ResponseEntity<R> r = Response.fail(httpStatus,resultStatus,message);
    ...
    protected Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ResponseEntity<R> result = exceptionHandlerResult.get();
